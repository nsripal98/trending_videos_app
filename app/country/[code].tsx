  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      try {
        ...
        const trendingData = await fetchTrendingVideos(code, null, selectedPlatform);
        setVideos(trendingData);
        
        // Fetch top content videos
        const contentData = await fetchTrendingVideos(code, null, selectedPlatform, true);
